...
public class billete {
	...
	public billete(int cod_Billete, int NTrayecto, int dni, String fecha, String hora, String Cod_Linea, String Cod_Bus, String Cod_Parada_Inicio, String Cod_Parada_Fin, double precio) {
