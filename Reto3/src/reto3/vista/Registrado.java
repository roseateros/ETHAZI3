...
public class Registrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 210, 160, 40));
    ...
    LlamarCliente llamar= new LlamarCliente(us.getText(),pass.getText()); 
    if (aux>0){
        dispose();
        aux=0;
    }
